...
class SettingsWindow(ttk.Frame, ThemeEngine):
    ...
    def __init__(self, master):
        ...
        master.title("Inventory Management System\ Settings")
        ...
        # Title Label
        title_label = ttk.Label(title_frame, text="Settings", font="Arial 60 bold",
                                 foreground='#22d3fe')
        title_label.pack()
        # Date and Time Label
...
if __name__ == "__main__":
    ...
    frame = SettingsWindow(master).pack()
    master.mainloop()